...
class AlignedBox {
 public:
   ...
   */
  template <typename Derived>
  EIGEN_DEVICE_FUNC inline NonInteger exteriorDistance(const MatrixBase<Derived>& p) const { EIGEN_USING_STD_MATH(sqrt)
   ...
   */
  EIGEN_DEVICE_FUNC inline NonInteger exteriorDistance(const AlignedBox& b) const { EIGEN_USING_STD_MATH(sqrt)
