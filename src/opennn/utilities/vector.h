...
template <class T>
T calculate_random_uniform(const T&, const T&);
template <class T>
T calculate_random_normal(const T&, const T&);
...
class Vector : public vector<T> {
 public:
  ...
  explicit Vector(const InputIterator&, const InputIterator&);
...
template <class T>
void Vector<T>::set() { this->resize(0); }
...
template <class T>
void Vector<T>::set(const string& file_name) {
  load(file_name);
}
...
template <class T>
void Vector<T>::initialize_sequential() {
...
template <class T>
size_t Vector<T>::count_not_equal_to(const Vector<T>& values) const {
  const size_t this_size = this->size();
...
template <class T>
Vector<double> Vector<T>::perform_Box_Cox_transformation(const double& lambda) const {
...
template <class T>
Vector<double> Vector<T>::calculate_percentage() const {
  const size_t this_size = this->size();
...
template <class T>
void Vector<T>::load(const string& file_name) {
...
template <class T>
void Vector<T>::save(const string& file_name, const char& separator) const {
