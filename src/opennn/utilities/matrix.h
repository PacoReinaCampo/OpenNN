...
size_t Matrix<T>::count_equal_to(const size_t& column_1_index, const Vector<T>& values_1,
  ...
  for (size_t i = 0; i < rows_number; i++) {
    if ((*this)(i, column_2_index) == value_2 && (*this)(i, column_3_index) == value_3 && (*this)(i, column_4_index) == value_4) {
      matrix_element = (*this)(i, column_1_index);
...
size_t Matrix<T>::count_equal_to(const size_t& column_1_index, const T& value_1,
  ...
  for (size_t i = 0; i < rows_number; i++) {
    if ((*this)(i, column_1_index) == value_1 && (*this)(i, column_2_index) == value_2 && (*this)(i, column_3_index) == value_3 && (*this)(i, column_4_index) == value_4) {
      count++;
    }
  }
...
template <class T>
bool Matrix<T>::is_column_constant(const size_t& column_index) const {
  if (columns_number == 0) {
    return false;
  }
...
Matrix<T> Matrix<T>::filter_column_equal_to(const size_t& column_1, const T& value_1,
  ...
  for (size_t i = 0; i < rows_number; i++) {
    if ((*this)(i, column_1) == value_1 && (*this)(i, column_2) == value_2 && (*this)(i, column_3) == value_3 && (*this)(i, column_4) == value_4) {
      row = get_row(i);
