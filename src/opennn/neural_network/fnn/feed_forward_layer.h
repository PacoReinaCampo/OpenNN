...
//   www.opennn.net
//
//   F E E D   F O R W A R D   L A Y E R   C L A S S   H E A D E R
//
...
class FeedForwardLayer : public Layer {
 public:
  ...
  explicit FeedForwardLayer();

  explicit FeedForwardLayer(const size_t&, const size_t&);
  ...
  const FeedForwardLayer::ActivationFunction& get_activation_function() const;
  const FeedForwardLayer::ActivationFunction& get_recurrent_activation_function() const;
  ...
  void set(const FeedForwardLayer&);
