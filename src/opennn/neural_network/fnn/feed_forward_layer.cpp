...
//   www.opennn.net
//
//   F E E D   F O R W A R D   L A Y E R   C L A S S
//
...
FeedForwardLayer::FeedForwardLayer(const size_t& new_inputs_number, const size_t& new_neurons_number) : Layer() {
...
FeedForwardLayer::FeedForwardLayer(const FeedForwardLayer& other_neuron_layer) : Layer() {
...
///
Vector<double> FeedForwardLayer::get_forget_biases() const {
...
Vector<double> FeedForwardLayer::get_input_biases() const {
  return input_biases;
}
...
Vector<double> FeedForwardLayer::get_state_biases() const {
  return state_biases;
}
...
Vector<double> FeedForwardLayer::get_output_biases() const {
...
///
Matrix<double> FeedForwardLayer::get_forget_weights() const {
...
Matrix<double> FeedForwardLayer::get_input_weights() const {
...
Matrix<double> FeedForwardLayer::get_state_weights() const {
...
Matrix<double> FeedForwardLayer::get_output_weights() const {
...
Matrix<double> FeedForwardLayer::get_forget_recurrent_weights() const {
...
Matrix<double> FeedForwardLayer::get_input_recurrent_weights() const {
...
Matrix<double> FeedForwardLayer::get_state_recurrent_weights() const {
...
Matrix<double> FeedForwardLayer::get_output_recurrent_weights() const {
...
Tensor<double> FeedForwardLayer::get_weights() const {
...
Tensor<double> FeedForwardLayer::get_recurrent_weights() const {
  const size_t neurons_number = get_neurons_number();
...
Matrix<double> FeedForwardLayer::get_biases() const {
  const size_t neurons_number = get_neurons_number();
...
size_t FeedForwardLayer::get_timesteps() const {
  return timesteps;
}
...
Vector<double> FeedForwardLayer::get_parameters() const {
...
const FeedForwardLayer::ActivationFunction& FeedForwardLayer::get_activation_function() const {
  return activation_function;
}

/// Returns the recurrent activation function of the layer.

const FeedForwardLayer::ActivationFunction& FeedForwardLayer::get_recurrent_activation_function() const {
...
string FeedForwardLayer::write_activation_function() const {
...
string FeedForwardLayer::write_recurrent_activation_function() const {
...
const bool& FeedForwardLayer::get_display() const {
  return display;
}
...
void FeedForwardLayer::set(const size_t& new_inputs_number, const size_t& new_neurons_number) {
...
/// @param other_neuron_layer FeedForwardLayer object to be copied.

void FeedForwardLayer::set(const FeedForwardLayer& other_neuron_layer) {
...
void FeedForwardLayer::set_default() {
  display = true;
}
...
void FeedForwardLayer::set_inputs_number(const size_t& new_inputs_number) {
  const size_t neurons_number = get_neurons_number();
...
void FeedForwardLayer::set_input_shape(const Vector<size_t>& size) {
...
void FeedForwardLayer::set_neurons_number(const size_t& new_neurons_number) {
  const size_t inputs_number = get_inputs_number();
...
void FeedForwardLayer::set_forget_biases(const Vector<double>& new_biases) {
...
///
void FeedForwardLayer::set_input_biases(const Vector<double>& new_biases) {
...
void FeedForwardLayer::set_state_biases(const Vector<double>& new_biases) {
...
void FeedForwardLayer::set_output_biases(const Vector<double>& new_biases) {
...
void FeedForwardLayer::set_forget_weights(const Matrix<double>& new_forget_weight) {
...
void FeedForwardLayer::set_input_weights(const Matrix<double>& new_input_weight) {
...
void FeedForwardLayer::set_state_weights(const Matrix<double>& new_state_weight) {
...
void FeedForwardLayer::set_output_weights(const Matrix<double>& new_output_weight) {
...
void FeedForwardLayer::set_forget_recurrent_weights(const Matrix<double>& new_forget_recurrent_weight) {
...
void FeedForwardLayer::set_input_recurrent_weights(const Matrix<double>& new_input_recurrent_weight) {
...
void FeedForwardLayer::set_state_recurrent_weights(const Matrix<double>& new_state_recurrent_weight) {
...
void FeedForwardLayer::set_output_recurrent_weights(const Matrix<double>& new_output_recurrent_weight) {
...
void FeedForwardLayer::set_parameters(const Vector<double>& new_parameters) {
  const size_t neurons_number = get_neurons_number();
  const size_t inputs_number = get_inputs_number();
  ...
  if (new_parameters_size != parameters_number) {
    ...
    buffer << "OpenNN Exception: FeedForwardLayer class.\n"
...
void FeedForwardLayer::set_activation_function(const FeedForwardLayer::ActivationFunction& new_activation_function) {
...
void FeedForwardLayer::set_activation_function(const string& new_activation_function_name) {
...
void FeedForwardLayer::set_recurrent_activation_function(const FeedForwardLayer::ActivationFunction& new_recurrent_activation_function) {
...
void FeedForwardLayer::set_recurrent_activation_function(const string& new_recurrent_activation_function_name) {
...
void FeedForwardLayer::set_timesteps(const size_t& new_timesteps) {
...
void FeedForwardLayer::set_display(const bool& new_display) {
  display = new_display;
}
...
void FeedForwardLayer::initialize_biases(const double& value) {
...
void FeedForwardLayer::initialize_forget_biases(const double& value) {
  forget_biases.initialize(value);
}
...
void FeedForwardLayer::initialize_input_biases(const double& value) {
  input_biases.initialize(value);
}
...
void FeedForwardLayer::initialize_state_biases(const double& value) {
  state_biases.initialize(value);
}
...
void FeedForwardLayer::initialize_output_biases(const double& value) {
  output_biases.initialize(value);
}
...
void FeedForwardLayer::initialize_weights(const double& value) {
...
void FeedForwardLayer::initialize_forget_weights(const double& value) {
  forget_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_input_weights(const double& value) {
  input_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_state_weights(const double& value) {
  state_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_output_weights(const double& value) {
  output_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_recurrent_weights(const double& value) {
...
void FeedForwardLayer::initialize_forget_recurrent_weights(const double& value) {
  forget_recurrent_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_input_recurrent_weights(const double& value) {
  input_recurrent_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_state_recurrent_weights(const double& value) {
  state_recurrent_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_output_recurrent_weights(const double& value) {
  output_recurrent_weights.initialize(value);
}
...
void FeedForwardLayer::initialize_hidden_states(const double& value) {
...
void FeedForwardLayer::initialize_cell_states(const double& value) {
  cell_states.initialize(value);
}

void FeedForwardLayer::initialize_weights_Glorot(const double& minimum, const double& maximum) {
...
void FeedForwardLayer::initialize_parameters(const double& value) {
  forget_biases.initialize(value);
  input_biases.initialize(value);
  state_biases.initialize(value);
  output_biases.initialize(value);
...
void FeedForwardLayer::randomize_parameters_uniform() {
...
void FeedForwardLayer::randomize_parameters_uniform(const double& minimum, const double& maximum) {
...
void FeedForwardLayer::randomize_parameters_normal(const double& mean, const double& standard_deviation) {
...
double FeedForwardLayer::calculate_parameters_norm() const {
  return (l2_norm(get_parameters()));
}

Vector<double> FeedForwardLayer::calculate_forget_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_input_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_state_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_output_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> FeedForwardLayer::calculate_activations_states(const Tensor<double>& inputs) {
...
Tensor<double> FeedForwardLayer::calculate_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> FeedForwardLayer::calculate_recurrent_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_recurrent_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> FeedForwardLayer::calculate_activations_derivatives(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> FeedForwardLayer::calculate_recurrent_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
void FeedForwardLayer::update_cell_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
void FeedForwardLayer::update_hidden_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> FeedForwardLayer::calculate_outputs(const Tensor<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> FeedForwardLayer::calculate_outputs(const Tensor<double>& inputs, const Vector<double>& parameters) {
  const size_t inputs_number = get_inputs_number();
...
Tensor<double> FeedForwardLayer::calculate_outputs(const Tensor<double>& inputs, const Matrix<double>& new_biases, const Tensor<double>& new_weights, const Tensor<double>& new_recurrent_weights) {
  const size_t neurons_number = get_neurons_number();
...
Layer::FirstOrderActivations FeedForwardLayer::calculate_first_order_activations(const Tensor<double>& inputs) {
  const size_t instances_number = inputs.get_dimension(0);
  const size_t neurons_number = get_neurons_number();
...
Tensor<double> FeedForwardLayer::calculate_output_delta(const Tensor<double>&, const Tensor<double>& output_gradient) const {
  return output_gradient;
}

Tensor<double> FeedForwardLayer::calculate_hidden_delta(Layer* next_layer_pointer,
                                                        const Tensor<double>&,
                                                        const Tensor<double>&,
...
Vector<double> FeedForwardLayer::calculate_error_gradient(const Tensor<double>& inputs,
...
Vector<double> FeedForwardLayer::calculate_forget_weights_error_gradient(const Tensor<double>& inputs,
                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                         const Tensor<double>& deltas,
...
Vector<double> FeedForwardLayer::calculate_input_weights_error_gradient(const Tensor<double>& inputs,
                                                                        const Layer::FirstOrderActivations& first_order_activations,
                                                                        const Tensor<double>& deltas,
                                                                        const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_state_weights_error_gradient(const Tensor<double>& inputs,
                                                                        const Layer::FirstOrderActivations& first_order_activations,
                                                                        const Tensor<double>& deltas,
                                                                        const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_output_weights_error_gradient(const Tensor<double>& inputs,
                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                         const Tensor<double>& deltas,
                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_forget_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                   const Layer::FirstOrderActivations& first_order_activations,
                                                                                   const Tensor<double>& deltas,
                                                                                   const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_input_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                  const Layer::FirstOrderActivations& first_order_activations,
                                                                                  const Tensor<double>& deltas,
                                                                                  const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_state_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                  const Layer::FirstOrderActivations& first_order_activations,
                                                                                  const Tensor<double>& deltas,
                                                                                  const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_output_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                   const Layer::FirstOrderActivations& first_order_activations,
                                                                                   const Tensor<double>& deltas,
                                                                                   const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_forget_biases_error_gradient(const Tensor<double>& inputs,
                                                                        const Layer::FirstOrderActivations& first_order_activations,
                                                                        const Tensor<double>& deltas,
                                                                        const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_input_biases_error_gradient(const Tensor<double>& inputs,
                                                                       const Layer::FirstOrderActivations& first_order_activations,
                                                                       const Tensor<double>& deltas,
                                                                       const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_state_biases_error_gradient(const Tensor<double>& inputs,
                                                                       const Layer::FirstOrderActivations& first_order_activations,
                                                                       const Tensor<double>& deltas,
                                                                       const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> FeedForwardLayer::calculate_output_biases_error_gradient(const Tensor<double>& inputs,
                                                                        const Layer::FirstOrderActivations& first_order_activations,
                                                                        const Tensor<double>& deltas,
                                                                        const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
string FeedForwardLayer::write_expression(const Vector<string>& inputs_names, const Vector<string>& outputs_names) const {
  const size_t neurons_number = get_neurons_number();
...
string FeedForwardLayer::object_to_string() const {
  const size_t inputs_number = get_inputs_number();
  const size_t neurons_number = get_neurons_number();
...
string FeedForwardLayer::write_recurrent_activation_function_expression() const {
  switch (recurrent_activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
...
string FeedForwardLayer::write_activation_function_expression() const {
  switch (activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
