...
MultiheadAttentionLayer::MultiheadAttentionLayer(const size_t& new_inputs_number, const size_t& new_neurons_number) : Layer() {
...
MultiheadAttentionLayer::MultiheadAttentionLayer(const MultiheadAttentionLayer& other_neuron_layer) : Layer() {
...
size_t MultiheadAttentionLayer::get_inputs_number() const {
  return input_weights.get_rows_number();
}

/// Returns the size of the neurons vector.

size_t MultiheadAttentionLayer::get_neurons_number() const {
...
///
Vector<double> MultiheadAttentionLayer::get_forget_biases() const {
...
Vector<double> MultiheadAttentionLayer::get_input_biases() const {
  return input_biases;
}
...
Vector<double> MultiheadAttentionLayer::get_state_biases() const {
  return state_biases;
}
...
Vector<double> MultiheadAttentionLayer::get_output_biases() const {
...
///
Matrix<double> MultiheadAttentionLayer::get_forget_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_input_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_state_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_output_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_forget_recurrent_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_input_recurrent_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_state_recurrent_weights() const {
...
Matrix<double> MultiheadAttentionLayer::get_output_recurrent_weights() const {
...
Tensor<double> MultiheadAttentionLayer::get_weights() const {
...
Tensor<double> MultiheadAttentionLayer::get_recurrent_weights() const {
  const size_t neurons_number = get_neurons_number();
...
Matrix<double> MultiheadAttentionLayer::get_biases() const {
  const size_t neurons_number = get_neurons_number();
...
size_t MultiheadAttentionLayer::get_timesteps() const {
  return timesteps;
}
...
Vector<double> MultiheadAttentionLayer::get_parameters() const {
...
const MultiheadAttentionLayer::ActivationFunction& MultiheadAttentionLayer::get_recurrent_activation_function() const {
...
string MultiheadAttentionLayer::write_recurrent_activation_function() const {
...
void MultiheadAttentionLayer::set(const size_t& new_inputs_number, const size_t& new_neurons_number) {
...
/// @param other_neuron_layer MultiheadAttentionLayer object to be copied.

void MultiheadAttentionLayer::set(const MultiheadAttentionLayer& other_neuron_layer) {
...
void MultiheadAttentionLayer::set_inputs_number(const size_t& new_inputs_number) {
  const size_t neurons_number = get_neurons_number();
...
void MultiheadAttentionLayer::set_input_shape(const Vector<size_t>& size) {
...
void MultiheadAttentionLayer::set_neurons_number(const size_t& new_neurons_number) {
  const size_t inputs_number = get_inputs_number();
...
void MultiheadAttentionLayer::set_forget_biases(const Vector<double>& new_biases) {
...
///
void MultiheadAttentionLayer::set_input_biases(const Vector<double>& new_biases) {
...
void MultiheadAttentionLayer::set_state_biases(const Vector<double>& new_biases) {
...
void MultiheadAttentionLayer::set_output_biases(const Vector<double>& new_biases) {
...
void MultiheadAttentionLayer::set_forget_weights(const Matrix<double>& new_forget_weight) {
...
void MultiheadAttentionLayer::set_input_weights(const Matrix<double>& new_input_weight) {
...
void MultiheadAttentionLayer::set_state_weights(const Matrix<double>& new_state_weight) {
...
void MultiheadAttentionLayer::set_output_weights(const Matrix<double>& new_output_weight) {
...
void MultiheadAttentionLayer::set_forget_recurrent_weights(const Matrix<double>& new_forget_recurrent_weight) {
...
void MultiheadAttentionLayer::set_input_recurrent_weights(const Matrix<double>& new_input_recurrent_weight) {
...
void MultiheadAttentionLayer::set_state_recurrent_weights(const Matrix<double>& new_state_recurrent_weight) {
...
void MultiheadAttentionLayer::set_output_recurrent_weights(const Matrix<double>& new_output_recurrent_weight) {
...
void MultiheadAttentionLayer::set_parameters(const Vector<double>& new_parameters) {
  const size_t neurons_number = get_neurons_number();
  const size_t inputs_number = get_inputs_number();
...
void MultiheadAttentionLayer::set_recurrent_activation_function(const MultiheadAttentionLayer::ActivationFunction& new_recurrent_activation_function) {
...
void MultiheadAttentionLayer::set_recurrent_activation_function(const string& new_recurrent_activation_function_name) {
...
void MultiheadAttentionLayer::set_timesteps(const size_t& new_timesteps) {
...
void MultiheadAttentionLayer::initialize_biases(const double& value) {
...
void MultiheadAttentionLayer::initialize_forget_biases(const double& value) {
  forget_biases.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_input_biases(const double& value) {
  input_biases.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_state_biases(const double& value) {
  state_biases.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_output_biases(const double& value) {
  output_biases.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_weights(const double& value) {
...
void MultiheadAttentionLayer::initialize_forget_weights(const double& value) {
  forget_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_input_weights(const double& value) {
  input_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_state_weights(const double& value) {
  state_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_output_weights(const double& value) {
  output_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_recurrent_weights(const double& value) {
...
void MultiheadAttentionLayer::initialize_forget_recurrent_weights(const double& value) {
  forget_recurrent_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_input_recurrent_weights(const double& value) {
  input_recurrent_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_state_recurrent_weights(const double& value) {
  state_recurrent_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_output_recurrent_weights(const double& value) {
  output_recurrent_weights.initialize(value);
}
...
void MultiheadAttentionLayer::initialize_hidden_states(const double& value) {
...
void MultiheadAttentionLayer::initialize_cell_states(const double& value) {
  cell_states.initialize(value);
}

void MultiheadAttentionLayer::initialize_weights_Glorot(const double& minimum, const double& maximum) {
...
void MultiheadAttentionLayer::initialize_parameters(const double& value) {
  forget_biases.initialize(value);
  input_biases.initialize(value);
  state_biases.initialize(value);
  output_biases.initialize(value);
...
void MultiheadAttentionLayer::randomize_parameters_uniform() {
...
void MultiheadAttentionLayer::randomize_parameters_uniform(const double& minimum, const double& maximum) {
...
void MultiheadAttentionLayer::randomize_parameters_normal(const double& mean, const double& standard_deviation) {
...
double MultiheadAttentionLayer::calculate_parameters_norm() const {
  return (l2_norm(get_parameters()));
}

Vector<double> MultiheadAttentionLayer::calculate_forget_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_input_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_state_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_output_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> MultiheadAttentionLayer::calculate_activations_states(const Tensor<double>& inputs) {
...
Tensor<double> MultiheadAttentionLayer::calculate_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> MultiheadAttentionLayer::calculate_recurrent_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_recurrent_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> MultiheadAttentionLayer::calculate_activations_derivatives(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> MultiheadAttentionLayer::calculate_recurrent_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
void MultiheadAttentionLayer::update_cell_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
void MultiheadAttentionLayer::update_hidden_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> MultiheadAttentionLayer::calculate_outputs(const Tensor<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> MultiheadAttentionLayer::calculate_outputs(const Tensor<double>& inputs, const Vector<double>& parameters) {
  const size_t inputs_number = get_inputs_number();
...
Tensor<double> MultiheadAttentionLayer::calculate_outputs(const Tensor<double>& inputs, const Matrix<double>& new_biases, const Tensor<double>& new_weights, const Tensor<double>& new_recurrent_weights) {
  const size_t neurons_number = get_neurons_number();
...
Layer::FirstOrderActivations MultiheadAttentionLayer::calculate_first_order_activations(const Tensor<double>& inputs) {
  const size_t instances_number = inputs.get_dimension(0);
  const size_t neurons_number = get_neurons_number();
...
Tensor<double> MultiheadAttentionLayer::calculate_output_delta(const Tensor<double>&, const Tensor<double>& output_gradient) const {
  return output_gradient;
}

Tensor<double> MultiheadAttentionLayer::calculate_hidden_delta(Layer* next_layer_pointer,
                                                               const Tensor<double>&,
                                                               const Tensor<double>&,
...
Vector<double> MultiheadAttentionLayer::calculate_error_gradient(const Tensor<double>& inputs,
...
Vector<double> MultiheadAttentionLayer::calculate_forget_weights_error_gradient(const Tensor<double>& inputs,
                                                                                const Layer::FirstOrderActivations& first_order_activations,
                                                                                const Tensor<double>& deltas,
...
Vector<double> MultiheadAttentionLayer::calculate_input_weights_error_gradient(const Tensor<double>& inputs,
                                                                               const Layer::FirstOrderActivations& first_order_activations,
                                                                               const Tensor<double>& deltas,
                                                                               const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_state_weights_error_gradient(const Tensor<double>& inputs,
                                                                               const Layer::FirstOrderActivations& first_order_activations,
                                                                               const Tensor<double>& deltas,
                                                                               const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_output_weights_error_gradient(const Tensor<double>& inputs,
                                                                                const Layer::FirstOrderActivations& first_order_activations,
                                                                                const Tensor<double>& deltas,
                                                                                const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_forget_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                          const Layer::FirstOrderActivations& first_order_activations,
                                                                                          const Tensor<double>& deltas,
                                                                                          const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_input_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                                         const Tensor<double>& deltas,
                                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_state_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                                         const Tensor<double>& deltas,
                                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_output_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                          const Layer::FirstOrderActivations& first_order_activations,
                                                                                          const Tensor<double>& deltas,
                                                                                          const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_forget_biases_error_gradient(const Tensor<double>& inputs,
                                                                               const Layer::FirstOrderActivations& first_order_activations,
                                                                               const Tensor<double>& deltas,
                                                                               const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_input_biases_error_gradient(const Tensor<double>& inputs,
                                                                              const Layer::FirstOrderActivations& first_order_activations,
                                                                              const Tensor<double>& deltas,
                                                                              const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_state_biases_error_gradient(const Tensor<double>& inputs,
                                                                              const Layer::FirstOrderActivations& first_order_activations,
                                                                              const Tensor<double>& deltas,
                                                                              const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> MultiheadAttentionLayer::calculate_output_biases_error_gradient(const Tensor<double>& inputs,
                                                                               const Layer::FirstOrderActivations& first_order_activations,
                                                                               const Tensor<double>& deltas,
                                                                               const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
string MultiheadAttentionLayer::write_expression(const Vector<string>& inputs_names, const Vector<string>& outputs_names) const {
  const size_t neurons_number = get_neurons_number();
...
string MultiheadAttentionLayer::object_to_string() const {
  const size_t inputs_number = get_inputs_number();
  const size_t neurons_number = get_neurons_number();
...
string MultiheadAttentionLayer::write_recurrent_activation_function_expression() const {
  switch (recurrent_activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
