...
//   www.opennn.net
//
//   N E U R A L   T U R I N G   M A C H I N E   L A Y E R   C L A S S
//
...
#include "Neural_turing_machine_layer.h"
...
NeuralTuringMachineLayer::NeuralTuringMachineLayer() : Layer() {
  set();

  layer_type = NeuralTuringMachine;
}
...
NeuralTuringMachineLayer::NeuralTuringMachineLayer(const size_t& new_inputs_number, const size_t& new_neurons_number) : Layer() {
...
NeuralTuringMachineLayer::NeuralTuringMachineLayer(const NeuralTuringMachineLayer& other_neuron_layer) : Layer() {
...
NeuralTuringMachineLayer::~NeuralTuringMachineLayer() {
}

/// Returns the number of inputs to the layer.

size_t NeuralTuringMachineLayer::get_inputs_number() const {
  return input_weights.get_rows_number();
}

/// Returns the size of the neurons vector.

size_t NeuralTuringMachineLayer::get_neurons_number() const {
  return output_biases.size();
}

/// Returns the number of parameters (biases, weights, recurrent weights) of the layer.

size_t NeuralTuringMachineLayer::get_parameters_number() const {
...
///
Vector<double> NeuralTuringMachineLayer::get_forget_biases() const {
...
Vector<double> NeuralTuringMachineLayer::get_input_biases() const {
  return input_biases;
}
...
Vector<double> NeuralTuringMachineLayer::get_state_biases() const {
  return state_biases;
}
...
Vector<double> NeuralTuringMachineLayer::get_output_biases() const {
...
///
Matrix<double> NeuralTuringMachineLayer::get_forget_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_input_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_state_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_output_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_forget_recurrent_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_input_recurrent_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_state_recurrent_weights() const {
...
Matrix<double> NeuralTuringMachineLayer::get_output_recurrent_weights() const {
...
Tensor<double> NeuralTuringMachineLayer::get_weights() const {
...
Tensor<double> NeuralTuringMachineLayer::get_recurrent_weights() const {
  const size_t neurons_number = get_neurons_number();
...
Matrix<double> NeuralTuringMachineLayer::get_biases() const {
  const size_t neurons_number = get_neurons_number();
...
size_t NeuralTuringMachineLayer::get_timesteps() const {
  return timesteps;
}
...
Vector<double> NeuralTuringMachineLayer::get_parameters() const {
...
const NeuralTuringMachineLayer::ActivationFunction& NeuralTuringMachineLayer::get_activation_function() const {
  return activation_function;
}

/// Returns the recurrent activation function of the layer.

const NeuralTuringMachineLayer::ActivationFunction& NeuralTuringMachineLayer::get_recurrent_activation_function() const {
...
string NeuralTuringMachineLayer::write_activation_function() const {
...
string NeuralTuringMachineLayer::write_recurrent_activation_function() const {
...
const bool& NeuralTuringMachineLayer::get_display() const {
  return display;
}
...
void NeuralTuringMachineLayer::set() {
  set_default();
}
...
void NeuralTuringMachineLayer::set(const size_t& new_inputs_number, const size_t& new_neurons_number) {
...
/// @param other_neuron_layer NeuralTuringMachineLayer object to be copied.

void NeuralTuringMachineLayer::set(const NeuralTuringMachineLayer& other_neuron_layer) {
...
void NeuralTuringMachineLayer::set_default() {
  display = true;
}
...
void NeuralTuringMachineLayer::set_inputs_number(const size_t& new_inputs_number) {
  const size_t neurons_number = get_neurons_number();
...
void NeuralTuringMachineLayer::set_input_shape(const Vector<size_t>& size) {
...
void NeuralTuringMachineLayer::set_neurons_number(const size_t& new_neurons_number) {
  const size_t inputs_number = get_inputs_number();
...
void NeuralTuringMachineLayer::set_forget_biases(const Vector<double>& new_biases) {
...
///
void NeuralTuringMachineLayer::set_input_biases(const Vector<double>& new_biases) {
...
void NeuralTuringMachineLayer::set_state_biases(const Vector<double>& new_biases) {
...
void NeuralTuringMachineLayer::set_output_biases(const Vector<double>& new_biases) {
...
void NeuralTuringMachineLayer::set_forget_weights(const Matrix<double>& new_forget_weight) {
...
void NeuralTuringMachineLayer::set_input_weights(const Matrix<double>& new_input_weight) {
...
void NeuralTuringMachineLayer::set_state_weights(const Matrix<double>& new_state_weight) {
...
void NeuralTuringMachineLayer::set_output_weights(const Matrix<double>& new_output_weight) {
...
void NeuralTuringMachineLayer::set_forget_recurrent_weights(const Matrix<double>& new_forget_recurrent_weight) {
...
void NeuralTuringMachineLayer::set_input_recurrent_weights(const Matrix<double>& new_input_recurrent_weight) {
...
void NeuralTuringMachineLayer::set_state_recurrent_weights(const Matrix<double>& new_state_recurrent_weight) {
...
void NeuralTuringMachineLayer::set_output_recurrent_weights(const Matrix<double>& new_output_recurrent_weight) {
...
void NeuralTuringMachineLayer::set_parameters(const Vector<double>& new_parameters) {
  const size_t neurons_number = get_neurons_number();
  const size_t inputs_number = get_inputs_number();
  ...
  if (new_parameters_size != parameters_number) {
    ...
    buffer << "OpenNN Exception: NeuralTuringMachineLayer class.\n"
...
void NeuralTuringMachineLayer::set_activation_function(const NeuralTuringMachineLayer::ActivationFunction& new_activation_function) {
...
void NeuralTuringMachineLayer::set_activation_function(const string& new_activation_function_name) {
...
void NeuralTuringMachineLayer::set_recurrent_activation_function(const NeuralTuringMachineLayer::ActivationFunction& new_recurrent_activation_function) {
...
void NeuralTuringMachineLayer::set_recurrent_activation_function(const string& new_recurrent_activation_function_name) {
...
void NeuralTuringMachineLayer::set_timesteps(const size_t& new_timesteps) {
...
void NeuralTuringMachineLayer::set_display(const bool& new_display) {
  display = new_display;
}
...
void NeuralTuringMachineLayer::initialize_biases(const double& value) {
...
void NeuralTuringMachineLayer::initialize_forget_biases(const double& value) {
  forget_biases.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_input_biases(const double& value) {
  input_biases.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_state_biases(const double& value) {
  state_biases.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_output_biases(const double& value) {
  output_biases.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_weights(const double& value) {
...
void NeuralTuringMachineLayer::initialize_forget_weights(const double& value) {
  forget_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_input_weights(const double& value) {
  input_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_state_weights(const double& value) {
  state_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_output_weights(const double& value) {
  output_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_recurrent_weights(const double& value) {
...
void NeuralTuringMachineLayer::initialize_forget_recurrent_weights(const double& value) {
  forget_recurrent_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_input_recurrent_weights(const double& value) {
  input_recurrent_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_state_recurrent_weights(const double& value) {
  state_recurrent_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_output_recurrent_weights(const double& value) {
  output_recurrent_weights.initialize(value);
}
...
void NeuralTuringMachineLayer::initialize_hidden_states(const double& value) {
...
void NeuralTuringMachineLayer::initialize_cell_states(const double& value) {
  cell_states.initialize(value);
}

void NeuralTuringMachineLayer::initialize_weights_Glorot(const double& minimum, const double& maximum) {
...
void NeuralTuringMachineLayer::initialize_parameters(const double& value) {
  forget_biases.initialize(value);
  input_biases.initialize(value);
  state_biases.initialize(value);
  output_biases.initialize(value);
...
void NeuralTuringMachineLayer::randomize_parameters_uniform() {
...
void NeuralTuringMachineLayer::randomize_parameters_uniform(const double& minimum, const double& maximum) {
...
void NeuralTuringMachineLayer::randomize_parameters_normal(const double& mean, const double& standard_deviation) {
...
double NeuralTuringMachineLayer::calculate_parameters_norm() const {
  return (l2_norm(get_parameters()));
}

Vector<double> NeuralTuringMachineLayer::calculate_forget_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_input_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_state_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_output_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> NeuralTuringMachineLayer::calculate_activations_states(const Tensor<double>& inputs) {
...
Tensor<double> NeuralTuringMachineLayer::calculate_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> NeuralTuringMachineLayer::calculate_recurrent_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_recurrent_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> NeuralTuringMachineLayer::calculate_activations_derivatives(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> NeuralTuringMachineLayer::calculate_recurrent_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
void NeuralTuringMachineLayer::update_cell_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
void NeuralTuringMachineLayer::update_hidden_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> NeuralTuringMachineLayer::calculate_outputs(const Tensor<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> NeuralTuringMachineLayer::calculate_outputs(const Tensor<double>& inputs, const Vector<double>& parameters) {
  const size_t inputs_number = get_inputs_number();
...
Tensor<double> NeuralTuringMachineLayer::calculate_outputs(const Tensor<double>& inputs, const Matrix<double>& new_biases, const Tensor<double>& new_weights, const Tensor<double>& new_recurrent_weights) {
  const size_t neurons_number = get_neurons_number();
...
Layer::FirstOrderActivations NeuralTuringMachineLayer::calculate_first_order_activations(const Tensor<double>& inputs) {
  const size_t instances_number = inputs.get_dimension(0);
  const size_t neurons_number = get_neurons_number();
...
Tensor<double> NeuralTuringMachineLayer::calculate_output_delta(const Tensor<double>&, const Tensor<double>& output_gradient) const {
  return output_gradient;
}

Tensor<double> NeuralTuringMachineLayer::calculate_hidden_delta(Layer* next_layer_pointer,
                                                                const Tensor<double>&,
                                                                const Tensor<double>&,
...
Vector<double> NeuralTuringMachineLayer::calculate_error_gradient(const Tensor<double>& inputs,
...
Vector<double> NeuralTuringMachineLayer::calculate_forget_weights_error_gradient(const Tensor<double>& inputs,
                                                                                 const Layer::FirstOrderActivations& first_order_activations,
                                                                                 const Tensor<double>& deltas,
...
Vector<double> NeuralTuringMachineLayer::calculate_input_weights_error_gradient(const Tensor<double>& inputs,
                                                                                const Layer::FirstOrderActivations& first_order_activations,
                                                                                const Tensor<double>& deltas,
                                                                                const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_state_weights_error_gradient(const Tensor<double>& inputs,
                                                                                const Layer::FirstOrderActivations& first_order_activations,
                                                                                const Tensor<double>& deltas,
                                                                                const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_output_weights_error_gradient(const Tensor<double>& inputs,
                                                                                 const Layer::FirstOrderActivations& first_order_activations,
                                                                                 const Tensor<double>& deltas,
                                                                                 const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_forget_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                           const Layer::FirstOrderActivations& first_order_activations,
                                                                                           const Tensor<double>& deltas,
                                                                                           const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_input_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                          const Layer::FirstOrderActivations& first_order_activations,
                                                                                          const Tensor<double>& deltas,
                                                                                          const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_state_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                          const Layer::FirstOrderActivations& first_order_activations,
                                                                                          const Tensor<double>& deltas,
                                                                                          const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_output_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                           const Layer::FirstOrderActivations& first_order_activations,
                                                                                           const Tensor<double>& deltas,
                                                                                           const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_forget_biases_error_gradient(const Tensor<double>& inputs,
                                                                                const Layer::FirstOrderActivations& first_order_activations,
                                                                                const Tensor<double>& deltas,
                                                                                const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_input_biases_error_gradient(const Tensor<double>& inputs,
                                                                               const Layer::FirstOrderActivations& first_order_activations,
                                                                               const Tensor<double>& deltas,
                                                                               const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_state_biases_error_gradient(const Tensor<double>& inputs,
                                                                               const Layer::FirstOrderActivations& first_order_activations,
                                                                               const Tensor<double>& deltas,
                                                                               const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> NeuralTuringMachineLayer::calculate_output_biases_error_gradient(const Tensor<double>& inputs,
                                                                                const Layer::FirstOrderActivations& first_order_activations,
                                                                                const Tensor<double>& deltas,
                                                                                const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
string NeuralTuringMachineLayer::write_expression(const Vector<string>& inputs_names, const Vector<string>& outputs_names) const {
  const size_t neurons_number = get_neurons_number();
...
string NeuralTuringMachineLayer::object_to_string() const {
  const size_t inputs_number = get_inputs_number();
  const size_t neurons_number = get_neurons_number();
...
string NeuralTuringMachineLayer::write_recurrent_activation_function_expression() const {
  switch (recurrent_activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
...
string NeuralTuringMachineLayer::write_activation_function_expression() const {
  switch (activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
