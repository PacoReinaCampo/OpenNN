...
//   www.opennn.net
//
//   D I F F E R E N T I A B L E   N E U R A L   C O M P U T E R   L A Y E R   C L A S S
//
...
#include "differentiable_neural_computer_layer.h"
...
DifferentiableNeuralComputerLayer::DifferentiableNeuralComputerLayer() : Layer() {
  set();

  layer_type = DifferentiableNeuralComputer;
}
...
DifferentiableNeuralComputerLayer::DifferentiableNeuralComputerLayer(const size_t& new_inputs_number, const size_t& new_neurons_number) : Layer() {
...
DifferentiableNeuralComputerLayer::DifferentiableNeuralComputerLayer(const DifferentiableNeuralComputerLayer& other_neuron_layer) : Layer() {
...
DifferentiableNeuralComputerLayer::~DifferentiableNeuralComputerLayer() {
}

/// Returns the number of inputs to the layer.

size_t DifferentiableNeuralComputerLayer::get_inputs_number() const {
  return input_weights.get_rows_number();
}

/// Returns the size of the neurons vector.

size_t DifferentiableNeuralComputerLayer::get_neurons_number() const {
  return output_biases.size();
}

/// Returns the number of parameters (biases, weights, recurrent weights) of the layer.

size_t DifferentiableNeuralComputerLayer::get_parameters_number() const {
...
///
Vector<double> DifferentiableNeuralComputerLayer::get_forget_biases() const {
...
Vector<double> DifferentiableNeuralComputerLayer::get_input_biases() const {
  return input_biases;
}
...
Vector<double> DifferentiableNeuralComputerLayer::get_state_biases() const {
  return state_biases;
}
...
Vector<double> DifferentiableNeuralComputerLayer::get_output_biases() const {
...
///
Matrix<double> DifferentiableNeuralComputerLayer::get_forget_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_input_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_state_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_output_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_forget_recurrent_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_input_recurrent_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_state_recurrent_weights() const {
...
Matrix<double> DifferentiableNeuralComputerLayer::get_output_recurrent_weights() const {
...
Tensor<double> DifferentiableNeuralComputerLayer::get_weights() const {
...
Tensor<double> DifferentiableNeuralComputerLayer::get_recurrent_weights() const {
  const size_t neurons_number = get_neurons_number();
...
Matrix<double> DifferentiableNeuralComputerLayer::get_biases() const {
  const size_t neurons_number = get_neurons_number();
...
size_t DifferentiableNeuralComputerLayer::get_timesteps() const {
  return timesteps;
}
...
Vector<double> DifferentiableNeuralComputerLayer::get_parameters() const {
...
const DifferentiableNeuralComputerLayer::ActivationFunction& DifferentiableNeuralComputerLayer::get_activation_function() const {
  return activation_function;
}

/// Returns the recurrent activation function of the layer.

const DifferentiableNeuralComputerLayer::ActivationFunction& DifferentiableNeuralComputerLayer::get_recurrent_activation_function() const {
...
string DifferentiableNeuralComputerLayer::write_activation_function() const {
...
string DifferentiableNeuralComputerLayer::write_recurrent_activation_function() const {
...
const bool& DifferentiableNeuralComputerLayer::get_display() const {
  return display;
}
...
void DifferentiableNeuralComputerLayer::set() {
  set_default();
}
...
void DifferentiableNeuralComputerLayer::set(const size_t& new_inputs_number, const size_t& new_neurons_number) {
...
/// @param other_neuron_layer DifferentiableNeuralComputerLayer object to be copied.

void DifferentiableNeuralComputerLayer::set(const DifferentiableNeuralComputerLayer& other_neuron_layer) {
...
void DifferentiableNeuralComputerLayer::set_default() {
  display = true;
}
...
void DifferentiableNeuralComputerLayer::set_inputs_number(const size_t& new_inputs_number) {
  const size_t neurons_number = get_neurons_number();
...
void DifferentiableNeuralComputerLayer::set_input_shape(const Vector<size_t>& size) {
...
void DifferentiableNeuralComputerLayer::set_neurons_number(const size_t& new_neurons_number) {
  const size_t inputs_number = get_inputs_number();
...
void DifferentiableNeuralComputerLayer::set_forget_biases(const Vector<double>& new_biases) {
...
///
void DifferentiableNeuralComputerLayer::set_input_biases(const Vector<double>& new_biases) {
...
void DifferentiableNeuralComputerLayer::set_state_biases(const Vector<double>& new_biases) {
...
void DifferentiableNeuralComputerLayer::set_output_biases(const Vector<double>& new_biases) {
...
void DifferentiableNeuralComputerLayer::set_forget_weights(const Matrix<double>& new_forget_weight) {
...
void DifferentiableNeuralComputerLayer::set_input_weights(const Matrix<double>& new_input_weight) {
...
void DifferentiableNeuralComputerLayer::set_state_weights(const Matrix<double>& new_state_weight) {
...
void DifferentiableNeuralComputerLayer::set_output_weights(const Matrix<double>& new_output_weight) {
...
void DifferentiableNeuralComputerLayer::set_forget_recurrent_weights(const Matrix<double>& new_forget_recurrent_weight) {
...
void DifferentiableNeuralComputerLayer::set_input_recurrent_weights(const Matrix<double>& new_input_recurrent_weight) {
...
void DifferentiableNeuralComputerLayer::set_state_recurrent_weights(const Matrix<double>& new_state_recurrent_weight) {
...
void DifferentiableNeuralComputerLayer::set_output_recurrent_weights(const Matrix<double>& new_output_recurrent_weight) {
...
void DifferentiableNeuralComputerLayer::set_parameters(const Vector<double>& new_parameters) {
  const size_t neurons_number = get_neurons_number();
  const size_t inputs_number = get_inputs_number();
  ...
  if (new_parameters_size != parameters_number) {
    ...
    buffer << "OpenNN Exception: DifferentiableNeuralComputerLayer class.\n"
...
void DifferentiableNeuralComputerLayer::set_activation_function(const DifferentiableNeuralComputerLayer::ActivationFunction& new_activation_function) {
...
void DifferentiableNeuralComputerLayer::set_activation_function(const string& new_activation_function_name) {
...
void DifferentiableNeuralComputerLayer::set_recurrent_activation_function(const DifferentiableNeuralComputerLayer::ActivationFunction& new_recurrent_activation_function) {
...
void DifferentiableNeuralComputerLayer::set_recurrent_activation_function(const string& new_recurrent_activation_function_name) {
...
void DifferentiableNeuralComputerLayer::set_timesteps(const size_t& new_timesteps) {
...
void DifferentiableNeuralComputerLayer::set_display(const bool& new_display) {
  display = new_display;
}
...
void DifferentiableNeuralComputerLayer::initialize_biases(const double& value) {
...
void DifferentiableNeuralComputerLayer::initialize_forget_biases(const double& value) {
  forget_biases.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_input_biases(const double& value) {
  input_biases.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_state_biases(const double& value) {
  state_biases.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_output_biases(const double& value) {
  output_biases.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_weights(const double& value) {
...
void DifferentiableNeuralComputerLayer::initialize_forget_weights(const double& value) {
  forget_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_input_weights(const double& value) {
  input_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_state_weights(const double& value) {
  state_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_output_weights(const double& value) {
  output_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_recurrent_weights(const double& value) {
...
void DifferentiableNeuralComputerLayer::initialize_forget_recurrent_weights(const double& value) {
  forget_recurrent_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_input_recurrent_weights(const double& value) {
  input_recurrent_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_state_recurrent_weights(const double& value) {
  state_recurrent_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_output_recurrent_weights(const double& value) {
  output_recurrent_weights.initialize(value);
}
...
void DifferentiableNeuralComputerLayer::initialize_hidden_states(const double& value) {
...
void DifferentiableNeuralComputerLayer::initialize_cell_states(const double& value) {
  cell_states.initialize(value);
}

void DifferentiableNeuralComputerLayer::initialize_weights_Glorot(const double& minimum, const double& maximum) {
...
void DifferentiableNeuralComputerLayer::initialize_parameters(const double& value) {
  forget_biases.initialize(value);
  input_biases.initialize(value);
  state_biases.initialize(value);
  output_biases.initialize(value);
...
void DifferentiableNeuralComputerLayer::randomize_parameters_uniform() {
...
void DifferentiableNeuralComputerLayer::randomize_parameters_uniform(const double& minimum, const double& maximum) {
...
void DifferentiableNeuralComputerLayer::randomize_parameters_normal(const double& mean, const double& standard_deviation) {
...
double DifferentiableNeuralComputerLayer::calculate_parameters_norm() const {
  return (l2_norm(get_parameters()));
}

Vector<double> DifferentiableNeuralComputerLayer::calculate_forget_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_input_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_state_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_output_combinations(const Vector<double>& inputs) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_activations_states(const Tensor<double>& inputs) {
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_recurrent_activations(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_recurrent_activations(const Vector<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_activations_derivatives(const Tensor<double>& combinations) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_recurrent_activations_derivatives(const Vector<double>& combination) const {
#ifdef __OPENNN_DEBUG__
...
void DifferentiableNeuralComputerLayer::update_cell_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
void DifferentiableNeuralComputerLayer::update_hidden_states(const Vector<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_outputs(const Tensor<double>& inputs) {
#ifdef __OPENNN_DEBUG__
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_outputs(const Tensor<double>& inputs, const Vector<double>& parameters) {
  const size_t inputs_number = get_inputs_number();
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_outputs(const Tensor<double>& inputs, const Matrix<double>& new_biases, const Tensor<double>& new_weights, const Tensor<double>& new_recurrent_weights) {
  const size_t neurons_number = get_neurons_number();
...
Layer::FirstOrderActivations DifferentiableNeuralComputerLayer::calculate_first_order_activations(const Tensor<double>& inputs) {
  const size_t instances_number = inputs.get_dimension(0);
  const size_t neurons_number = get_neurons_number();
...
Tensor<double> DifferentiableNeuralComputerLayer::calculate_output_delta(const Tensor<double>&, const Tensor<double>& output_gradient) const {
  return output_gradient;
}

Tensor<double> DifferentiableNeuralComputerLayer::calculate_hidden_delta(Layer* next_layer_pointer,
                                                                         const Tensor<double>&,
                                                                         const Tensor<double>&,
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_error_gradient(const Tensor<double>& inputs,
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_forget_weights_error_gradient(const Tensor<double>& inputs,
                                                                                          const Layer::FirstOrderActivations& first_order_activations,
                                                                                          const Tensor<double>& deltas,
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_weights_derivatives = cell_state_weights_derivatives.multiply_rows(current_forget_activations) + input_combinations_weights_derivatives.multiply_rows(current_state_activations) + state_combinations_weights_derivatives.multiply_rows(current_input_activations) + forget_combinations_weights_derivatives.multiply_rows((current_forget_derivatives * previous_cell_state_activations));
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_input_weights_error_gradient(const Tensor<double>& inputs,
                                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                                         const Tensor<double>& deltas,
                                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_weights_derivatives = cell_state_weights_derivatives.multiply_rows(current_forget_activations) + forget_combinations_weights_derivatives.multiply_rows(previous_cell_state_activations) + state_combinations_weights_derivatives.multiply_rows(current_input_activations) + input_combinations_weights_derivatives.multiply_rows((current_input_derivatives * current_state_activations));
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_state_weights_error_gradient(const Tensor<double>& inputs,
                                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                                         const Tensor<double>& deltas,
                                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_weights_derivatives = cell_state_weights_derivatives.multiply_rows(current_forget_activations) + forget_combinations_weights_derivatives.multiply_rows(previous_cell_state_activations) + input_combinations_weights_derivatives.multiply_rows(current_state_activations) + state_combinations_weights_derivatives.multiply_rows(current_state_derivatives * current_input_activations);
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_output_weights_error_gradient(const Tensor<double>& inputs,
                                                                                          const Layer::FirstOrderActivations& first_order_activations,
                                                                                          const Tensor<double>& deltas,
                                                                                          const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_forget_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                                    const Layer::FirstOrderActivations& first_order_activations,
                                                                                                    const Tensor<double>& deltas,
                                                                                                    const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    if (instance % timesteps == 0) {
      ...
      cell_state_recurrent_weights_derivatives = cell_state_recurrent_weights_derivatives.multiply_rows(current_forget_activations) + input_combinations_recurrent_weights_derivatives.multiply_rows(current_state_activations) + state_combinations_recurrent_weights_derivatives.multiply_rows(current_input_activations) + forget_combinations_recurrent_weights_derivatives.multiply_rows((current_forget_derivatives * previous_cell_state_activations));
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_input_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                                   const Layer::FirstOrderActivations& first_order_activations,
                                                                                                   const Tensor<double>& deltas,
                                                                                                   const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    if (instance % timesteps == 0) {
      ...
      cell_state_recurrent_weights_derivatives = cell_state_recurrent_weights_derivatives.multiply_rows(current_forget_activations) + input_combinations_recurrent_weights_derivatives.multiply_rows(current_input_derivatives * current_state_activations) + state_combinations_recurrent_weights_derivatives.multiply_rows(current_input_activations) + forget_combinations_recurrent_weights_derivatives.multiply_rows(previous_cell_state_activations);
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_state_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                                   const Layer::FirstOrderActivations& first_order_activations,
                                                                                                   const Tensor<double>& deltas,
                                                                                                   const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_output_recurrent_weights_error_gradient(const Tensor<double>& inputs,
                                                                                                    const Layer::FirstOrderActivations& first_order_activations,
                                                                                                    const Tensor<double>& deltas,
                                                                                                    const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_forget_biases_error_gradient(const Tensor<double>& inputs,
                                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                                         const Tensor<double>& deltas,
                                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_biases_derivatives = cell_state_biases_derivatives.multiply_rows(current_forget_activations) + input_combinations_biases_derivatives.multiply_rows(current_state_activations) + state_combinations_biases_derivatives.multiply_rows(current_input_activations) + forget_combinations_biases_derivatives.multiply_rows((current_forget_derivatives * previous_cell_state_activations));
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_input_biases_error_gradient(const Tensor<double>& inputs,
                                                                                        const Layer::FirstOrderActivations& first_order_activations,
                                                                                        const Tensor<double>& deltas,
                                                                                        const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_biases_derivatives = cell_state_biases_derivatives.multiply_rows(current_forget_activations) + forget_combinations_biases_derivatives.multiply_rows(previous_cell_state_activations) + state_combinations_biases_derivatives.multiply_rows(current_input_activations) + input_combinations_biases_derivatives.multiply_rows((current_input_derivatives * current_state_activations));
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_state_biases_error_gradient(const Tensor<double>& inputs,
                                                                                        const Layer::FirstOrderActivations& first_order_activations,
                                                                                        const Tensor<double>& deltas,
                                                                                        const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_biases_derivatives = cell_state_biases_derivatives.multiply_rows(current_forget_activations) + forget_combinations_biases_derivatives.multiply_rows(previous_cell_state_activations) + input_combinations_biases_derivatives.multiply_rows(current_state_activations) + state_combinations_biases_derivatives.multiply_rows((current_state_derivatives * current_input_activations));
...
Vector<double> DifferentiableNeuralComputerLayer::calculate_output_biases_error_gradient(const Tensor<double>& inputs,
                                                                                         const Layer::FirstOrderActivations& first_order_activations,
                                                                                         const Tensor<double>& deltas,
                                                                                         const Tensor<double>& activations_states) {
  const size_t instances_number = inputs.get_dimension(0);
  ...
  for (size_t instance = 0; instance < instances_number; instance++) {
    ...
    cell_state_biases_derivatives = cell_state_biases_derivatives.multiply_rows(current_forget_activations) + forget_combinations_biases_derivatives.multiply_rows(previous_cell_state_activations) + state_combinations_biases_derivatives.multiply_rows(current_input_activations) + input_combinations_biases_derivatives.multiply_rows(current_state_activations);
...
string DifferentiableNeuralComputerLayer::write_expression(const Vector<string>& inputs_names, const Vector<string>& outputs_names) const {
  const size_t neurons_number = get_neurons_number();
  ...
  for (size_t i = 0; i < neurons_number; i++) {
    buffer << outputs_names[i] << " = "
           << "hidden_state_" << to_string(i + 1) << "(t);\n";
  }

  return buffer.str();
}

string DifferentiableNeuralComputerLayer::object_to_string() const {
  const size_t inputs_number = get_inputs_number();
  const size_t neurons_number = get_neurons_number();
...
string DifferentiableNeuralComputerLayer::write_recurrent_activation_function_expression() const {
  switch (recurrent_activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
...
string DifferentiableNeuralComputerLayer::write_activation_function_expression() const {
  switch (activation_function) {
    case HyperbolicTangent: {
      return "tanh";
    }
